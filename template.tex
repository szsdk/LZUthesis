...
\title{{兰州大学本科论文非官方 \LaTeX 模板}{V0.20a}}
...
\dirtree{%
    ...
    .2 biblatex-gbt77142005-gbk.def\DTcomment{gbt编码模板中文定义文件}.
    .2 biblatex-gbt77142005-utf8.def\DTcomment{utf8编码模板中文定义文件}.
    .2 gbt77142005.bbx\DTcomment{顺序编码参考文献格式}.
    .2 gbt77142005.cbx\DTcomment{顺序编码引用格式}.
    .2 gbt77142005\_authoryear.bbx\DTcomment{编者-出版年参考文献格式}.
    .2 gbt77142005\_authoryear.cbx\DTcomment{编者-出版年引用格式}.
}
\section{参考文献}
