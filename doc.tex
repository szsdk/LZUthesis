...
\title{{兰州大学本科论文非官方}{\LaTeX 模板V0.2.2022}}
...
%package
\usepackage[outputdir=build]{minted} %代码格式
\usepackage{dirtree}
\usepackage{siunitx}
\usepackage{hologo}
\usepackage{manfnt}
...
\dirtree{%
    ...
    .3 signature.pdf\DTcomment{样例签名图片}.
    .2 simplest.pdf\DTcomment{示例 pdf 文件}.
    .2 simplest.tex\DTcomment{示例 \TeX 文件}.
    .2 帮助文档.pdf\DTcomment{帮助文档}.
}
\section{参考文献}
...
\end{question}
\begin{answer}
    对于大部分理科同学，可以强行指定使用Fandol字体，即在开头加入\mintinline{latex}{fontset}
\begin{minted}[breaklines,frame=single,]{latex}
